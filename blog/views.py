...
def post_list(request):
    ...
    return render(request, 'blog/post_list.html', {'posts': posts})  #to jest funkcja (def) o nazwie post_list, która przyjmuje zapytanie (request) i zwraca (return) funkcję zwaną render, której zadaniem jest wyrenderowanie (złożenie w całość) naszego szablonu blog/post_list.html.
